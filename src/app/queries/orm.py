    ...
    async def insert_users():
        async with async_session_factory() as session:
            ...
            if not existing_user:
                user1 = User(name="user1", email="user1@gmail.com", password=hash_password("12345678"))
                user2 = User(name="user2", email="user2@gmail.com", password=hash_password("87654321"))
